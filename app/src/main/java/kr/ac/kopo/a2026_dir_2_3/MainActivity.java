...
public class MainActivity extends AppCompatActivity {
    Button btnHome, btnCall, btnGallary, btnQuit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHome = findViewById(R.id.btn_hompage);
        btnCall = findViewById(R.id.btn_phonecall);
        ...
        btnQuit.setOnClickListener(btnListener);
    }
